...
FAQ_KNOWLEDGE = {
    "what_is_havenly": "Havenly is your AI-powered home concierge that helps you transform your space! We offer two main services: Buy mode (get AI suggestions to make your room cozy) and Sell mode (identify items to declutter and sell).",
    ...
    "pricing": "Yes! Havenly is completely free to use. You can analyze rooms, get suggestions, and save items without any cost.",
...
def generate_faq_response(message: str) -> str:
    ...
    if any(word in message_lower for word in ["what is", "what's", "about havenly", "explain"]):
        return FAQ_KNOWLEDGE["what_is_havenly"]
        ...
        return """I'm here to help with questions about Havenly! Here are some things I can tell you about:

• **What is Havenly?** - Learn about our AI-powered home concierge
...
async def faq_copilot_info():
    ...
    return JSONResponse(content={
        "runtime": "havenly-faq-copilot",
        "version": "1.0.0",
        "capabilities": ["chat"],
        "description": "FAQ assistant for Havenly questions"
    })
