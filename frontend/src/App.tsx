...
function App() {
  ...
  useEffect(() => {
    ...
    const hasSeenNotice = localStorage.getItem('havenly-deployment-notice')
    if (!hasSeenNotice) {
  ...
  const handleCloseModal = () => {
    ...
    localStorage.setItem('havenly-deployment-notice', 'true')
  }
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-body text-white/80 leading-relaxed">
                  <p>
                    Welcome to Havenly.ai! This is currently a <strong>frontend-only demonstration</strong> 
                    of our AI-powered home concierge platform.
                  </p>
                  
                  <p>
                    While the entire Havenly.ai pipeline works smoothly in our local development environment, 
